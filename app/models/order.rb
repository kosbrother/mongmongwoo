class Order < ActiveRecord::Base
  ...
  after_update :reduce_stock_amount_if_status_shipping, :restock_if_status_changed_from_shipping, :refund_spent_shopping_point_to_registered_user_if_status_cancel, :send_shopping_point_to_user_if_status_pickup
  ...
  def send_shopping_point_to_user_if_status_pickup
    if status_changed_to?("完成取貨")
