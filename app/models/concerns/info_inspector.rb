module InfoInspector
  ...
  included do
    after_save :set_blacklisted_by_checking_info, :set_is_repurchased_by_checking_info
  end
  ...
  def set_is_repurchased_by_checking_info
    if is_repurchased_order_info_data?
      update_column(:is_repurchased, true)
    end
  end
  ...
  def is_repurchased_order_info_data?
